    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 1) { suma = suma +786; }
                if (position == 2) { suma = suma +118; }
                if (position == 3) { suma = suma +172; }
                if (position == 4) { suma = suma +220; }
                if (position == 5) { suma = suma +148; }
                if (position == 6) { suma = suma +174; }
                if (position == 7) { suma = suma +185; }
                if (position == 8) { suma = suma +186; }
                if (position == 9) { suma = suma +135; }
                if (position == 10) { suma = suma +157; }
                if (position == 11) { suma = suma +148; }
                if (position == 12) { suma = suma +148; }
                if (position == 13) { suma = suma +233; }
                if (position == 14) { suma = suma +165; }
                if (position == 15) { suma = suma +133; }
                if (position == 16) { suma = suma +192; }
                if (position == 17) { suma = suma +136; }
                if (position == 18) { suma = suma +189; }
                if (position == 19) { suma = suma +191; }
                if (position == 20) { suma = suma +271; }
                if (position == 21) { suma = suma +284; }
                if (position == 22) { suma = suma +202; }
                if (position == 23) { suma = suma +173; }
                if (position == 24) { suma = suma +277; }
                if (position == 25) { suma = suma +159; }
                if (position == 26) { suma = suma +120; }
                if (position == 27) { suma = suma +118; }
                if (position == 28) { suma = suma +154; }
                if (position == 29) { suma = suma +273; }
                if (position == 30) { suma = suma +229; }
                if (position == 31) { suma = suma +152; }
                if (position == 32) { suma = suma +99; }
                if (position == 33) { suma = suma +120; }
                if (position == 34) { suma = suma +184; }
                if (position == 35) { suma = suma +120; }
                if (position == 36) { suma = suma +151; }
                if (position == 37) { suma = suma +158; }
                if (position == 38) { suma = suma +163; }
                if (position == 39) { suma = suma +73; }
                if (position == 40) { suma = suma +136; }
                if (position == 41) { suma = suma +138; }
                if (position == 42) { suma = suma +196; }
