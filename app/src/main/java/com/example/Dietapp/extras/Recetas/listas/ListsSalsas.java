...
ListView lista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoEdit=findViewById(R.id.editListas);
         valoresSalsa= new String[]{ "selecciona salsa", "ketchup", "mostaza", "mayonesa", "barbacoa", "salsa alioli", "salsa bechamel",
                 "salsa de soja", "salsa cesar", "tabasco",
                 "salsa de ajo", "", "salsa pesto", "salsa bernesa", "salsa dami-glace", "salsa pergourdine",
                 "salsa gravy", "salsa toffee", "salsa cumberland", "salsa boloñesa", "salsa carbonara", "salsa andalouse", "salsa tzatziki", "salsa amatriciana", "salsa alfredo",
                 "salsa puttanesca", "salsa gremolata", "salsa ajvar", "salsa piri-piri", "salsa oporto","salsa brava"};
