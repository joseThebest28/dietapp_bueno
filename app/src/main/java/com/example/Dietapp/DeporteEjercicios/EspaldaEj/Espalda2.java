...
public class Espalda2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.espalda2));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(Espalda2.this);
