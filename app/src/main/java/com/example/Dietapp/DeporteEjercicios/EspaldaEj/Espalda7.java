...
public class Espalda7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.espalda7));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(Espalda7.this);
       ...
       num=num+22;
        ...
        myEditor.commit();
        Intent i = new Intent(this, Espalda4.class );
