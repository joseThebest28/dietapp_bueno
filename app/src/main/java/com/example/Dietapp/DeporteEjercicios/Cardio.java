...
//en internet aparece gasto calorico cada 30 minutos, mediante una proporción saco las calorias por minuto de una persona de 70kg
                ...
                if (!res.isEmpty() && !res2.isEmpty()) {
                    ...
                    if (position == 6) {//Esquí
                        num2 = num2 * 60;
                        resultado = (float) ((num + num2) * 12);
                        toast1.show();
                    }

                    if (position == 7) {//Badminton
                        num2 = num2 * 60;
                        resultado = (float) ((num + num2) * 7.13);
                        toast1.show();
                    }

                    if (position == 8) {//Baloncesto
                        num2 = num2 * 60;
                        resultado = (float) ((num + num2) * 8.13);
                        toast1.show();
                    }

                    if (position == 9) {//Croquet
                        num2 = num2 * 60;
                        resultado = (float) ((num + num2) * 3.36);
                        toast1.show();
                    }
