...
public class Pecho2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.pecho2));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(Pecho2.this);
       ...
       num=num+35;
        ...
        myEditor.commit();
        Intent i = new Intent(this, Pecho3.class );
