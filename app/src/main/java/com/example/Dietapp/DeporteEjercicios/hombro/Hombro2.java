...
public class Hombro2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.hombro2));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(Hombro2.this);
