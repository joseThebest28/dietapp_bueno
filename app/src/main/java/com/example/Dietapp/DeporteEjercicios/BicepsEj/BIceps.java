...
public class BIceps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.biceps1));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(BIceps.this);
