...
public class BIceps4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen.setImageDrawable(getResources().getDrawable(R.drawable.biceps4));
    }

    public void completad(View view) {
        SharedPreferences myPreferences = PreferenceManager.getDefaultSharedPreferences(BIceps4.this);
       ...
       num=num+24;
        ...
        myEditor.commit();
        Intent i = new Intent(this, BIceps2.class );
